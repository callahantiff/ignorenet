...
When there is no raw data available on GEO, the GEO Data set SOFT files are downloaded and processed.
...
Create an expression set from the extracted data. Additionally, this step also investigates whether the data has been log2-transformed and pulls gene annotation information as well as sample group assignments.
```{r warning=FALSE, message=FALSE, eval=FALSE, cache=FALSE}
## GDS
# print column names
